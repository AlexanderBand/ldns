...
if read_the_docs_build:
    ...
    subprocess.call('doxygen libdns.doxygen', shell=True)
...
htmlhelp_basename = 'LdnsUserManualdoc'
...
latex_documents = [
    (master_doc, 'LdnsUserManual.tex', 'Ldns User Manual',
     'NLnet Labs', 'manual'),
]
...
man_pages = [
    (master_doc, 'ldnsusermanual', 'Ldns User Manual',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LdnsUserManual', 'Ldns User Manual',
     author, 'LdnsUserManual', 'One line description of project.',
     'Miscellaneous'),
]
